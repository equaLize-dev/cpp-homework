...
//		setlocale(LC_ALL, "");
//		do std::cout <<
//			"\nИнтересный факт: один из переводов слова \"right\" с английского - \"правильно\". Однако, \"прямоугольный треугольник\" на английском - \"right triangle\", а \"правильный треугольник\" - \"regular triangle\".\n"
//			"\"1\" - S == 0.5 * a * h\n" <<
